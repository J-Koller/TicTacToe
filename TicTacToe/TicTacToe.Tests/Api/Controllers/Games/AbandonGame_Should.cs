...
{
    public class AbandonGame_Should
    {
        ...
        public async Task NotReturn_Null()
        {
            ...
            var result = await sut.AbandonGame(null);
        ...
        public async Task Return_Ok_WhenSuccessful()
        {
            ...
            var result = await sut.AbandonGame(_gameResultDto) as ObjectResult;
        ...
        public async Task Handle_ArgumentNullException_With_BadRequest()
        {
            ...
            _gameServiceMock.Setup(gsm => gsm.AbandonGameAsync(_gameResultDto))
