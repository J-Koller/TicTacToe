...
{
    public class CleanInactivePlayers_Should
    {
        ...
        public CleanInactivePlayers_Should()
        {
        ...
        public async Task NotReturn_Null()
        {
            ...
            var result = await sut.CleanInactivePlayers();
        ...
        public async Task Return_Ok_WhenSuccessful()
        {
            ...
            var result = await sut.CleanInactivePlayers() as ObjectResult;
        ...
        public async Task Handle_ArgumentException_With_BadRequest()
        {
            ...
            _playerServiceMock.Setup(psm => psm.CleanInactivePlayersAsync())
